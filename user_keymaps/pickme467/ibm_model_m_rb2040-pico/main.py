...
PAUSE = KC.MEDIA_PLAY_PAUSE
VOL_UP = KC.AUDIO_VOL_UP
VOL_DN = KC.AUDIO_VOL_DOWN
COPY = KC.LCTL(KC.C)
CUT = KC.LCTL(KC.X)
PASTE = KC.LCTL(KC.V)
...
keymap_ibm_iso = [[
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    KC.ESC,    KC.F1,  KC.F2,  KC.F3,  KC.F4,   KC.F5,  KC.F6,  KC.F7,  KC.F8,   KC.F9, KC.F10, KC.F11, KC.F12,   KC.PSCR, KC.SLCK, PAUSE,
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    KC.GRV,  KC.N1, KC.N2, KC.N3, KC.N4, KC.N5, KC.N6, KC.N7, KC.N8, KC.N9, KC.N0,  KC.MINS,  KC.EQL,  KC.BSPC,   KC.INS,  KC.HOME, KC.PGUP,    KC.NLCK, COPY,    PASTE,   CUT,
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    KC.TAB,    KC.Q,  KC.W,  KC.E,  KC.R,  KC.T,  KC.Y,  KC.U,  KC.I,  KC.O,  KC.P, KC.LBRC, KC.RBRC,   KC.ENT,   KC.DEL,  KC.END,  KC.PGDN,    KC.P7,   KC.P8,   KC.P9,   VOL_UP,
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    KC.CLCK,    KC.A,  KC.S,  KC.D,  KC.F,  KC.G,  KC.H,  KC.J,  KC.K,  KC.L, KC.SCLN, KC.QUOT, KC.BSLS,                                        KC.P4,   KC.P5,   KC.P6,   VOL_DN,
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    KC.LSFT, KC.LGUI,  KC.Z,  KC.X,  KC.C,  KC.V,  KC.B,  KC.N,  KC.M,  KC.COMM,  KC.DOT,  KC.SLSH,    KC.RSFT,            KC.UP,               KC.P1,   KC.P2,   KC.P3,   KC.PENT,
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    KC.LCTL,        KC.LALT,                        KC.SPC,                       KC.RALT,             KC.RGUI,   KC.LEFT, KC.DOWN, KC.RIGHT,   KC.P0,            KC.PDOT,
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
]]
